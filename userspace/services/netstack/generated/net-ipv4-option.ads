...
is
   ...
   with
     Pre =>
       not Ctx'Constrained
       and Net.IPv4.Option.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       Net.IPv4.Option.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and then Buffer /= null
       and then Buffer'Length > 0
   ...
   with
     Pre =>
       Net.IPv4.Option.Has_Buffer (Ctx)
       and then Net.IPv4.Option.Well_Formed_Message (Ctx)
       and then Net.IPv4.Option.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Option.Has_Buffer (Ctx)
       and then Offset < Net.IPv4.Option.Buffer_Length (Ctx)
       and then Pre (Net.IPv4.Option.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       Net.IPv4.Option.Has_Buffer (Ctx)
       and then Net.IPv4.Option.Well_Formed_Message (Ctx)
       and then Data'Length = Net.IPv4.Option.Byte_Size (Ctx);
   ...
   with
     Pre =>
       Net.IPv4.Option.Has_Buffer (Ctx)
       and then Net.IPv4.Option.Valid_Value (Fld, Val)
       and then Net.IPv4.Option.Valid_Next (Ctx, Fld)
       and then Net.IPv4.Option.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   with
     Pre =>
       Net.IPv4.Option.Valid_Next (Ctx, Fld),
     Post =>
       (case Fld is
           when F_Option_Data =>
   ...
   with
     Pre =>
       Net.IPv4.Option.Has_Buffer (Ctx)
       and Net.IPv4.Option.Valid_Next (Ctx, Fld);
   ...
   with
     Pre =>
       Net.IPv4.Option.Valid (Ctx, Net.IPv4.Option.F_Copied);

   function Get_Option_Class (Ctx : Context) return Net.IPv4.Option_Class
   with
     Pre =>
       Net.IPv4.Option.Valid (Ctx, Net.IPv4.Option.F_Option_Class);

   function Get_Option_Number (Ctx : Context) return Net.IPv4.Option_Number
   with
     Pre =>
       Net.IPv4.Option.Valid (Ctx, Net.IPv4.Option.F_Option_Number);

   function Get_Option_Length (Ctx : Context) return Net.IPv4.Option_Length
   with
     Pre =>
       Net.IPv4.Option.Valid (Ctx, Net.IPv4.Option.F_Option_Length);
   ...
   with
     ...
     Pre =>
       Net.IPv4.Option.Has_Buffer (Ctx)
       and then Net.IPv4.Option.Well_Formed (Ctx, Net.IPv4.Option.F_Option_Data)
       and then Net.IPv4.Option.Valid_Next (Ctx, Net.IPv4.Option.F_Option_Data),
     Post =>
   ...
   with
     Pre =>
       ...
       and then Net.IPv4.Option.Well_Formed (Ctx, Net.IPv4.Option.F_Option_Data)
       and then Net.IPv4.Option.Valid_Next (Ctx, Net.IPv4.Option.F_Option_Data)
       and then Data'Length = RFLX_Types.To_Length (Net.IPv4.Option.Field_Size (Ctx, Net.IPv4.Option.F_Option_Data)),
     Post =>
   ...
   with
     Pre =>
       Net.IPv4.Option.Has_Buffer (Ctx)
       and Net.IPv4.Option.Present (Ctx, Net.IPv4.Option.F_Option_Data);
   ...
   with
     ...
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Option.Has_Buffer (Ctx)
       and then Net.IPv4.Option.Valid_Next (Ctx, Net.IPv4.Option.F_Copied)
       and then Valid_Boolean (To_Base_Integer (Val))
       and then Net.IPv4.Option.Available_Space (Ctx, Net.IPv4.Option.F_Copied) >= Net.IPv4.Option.Field_Size (Ctx, Net.IPv4.Option.F_Copied)
       and then Net.IPv4.Option.Field_Condition (Ctx, Net.IPv4.Option.F_Copied, To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Option_Class (Ctx : in out Context; Val : Net.IPv4.Option_Class)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Option.Has_Buffer (Ctx)
       and then Net.IPv4.Option.Valid_Next (Ctx, Net.IPv4.Option.F_Option_Class)
       and then Net.IPv4.Valid_Option_Class (Net.IPv4.To_Base_Integer (Val))
       and then Net.IPv4.Option.Available_Space (Ctx, Net.IPv4.Option.F_Option_Class) >= Net.IPv4.Option.Field_Size (Ctx, Net.IPv4.Option.F_Option_Class)
       and then Net.IPv4.Option.Field_Condition (Ctx, Net.IPv4.Option.F_Option_Class, Net.IPv4.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Option_Number (Ctx : in out Context; Val : Net.IPv4.Option_Number)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Option.Has_Buffer (Ctx)
       and then Net.IPv4.Option.Valid_Next (Ctx, Net.IPv4.Option.F_Option_Number)
       and then Net.IPv4.Valid_Option_Number (Net.IPv4.To_Base_Integer (Val))
       and then Net.IPv4.Option.Available_Space (Ctx, Net.IPv4.Option.F_Option_Number) >= Net.IPv4.Option.Field_Size (Ctx, Net.IPv4.Option.F_Option_Number)
       and then Net.IPv4.Option.Field_Condition (Ctx, Net.IPv4.Option.F_Option_Number, Net.IPv4.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Option_Length (Ctx : in out Context; Val : Net.IPv4.Option_Length)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Option.Has_Buffer (Ctx)
       and then Net.IPv4.Option.Valid_Next (Ctx, Net.IPv4.Option.F_Option_Length)
       and then Net.IPv4.Valid_Option_Length (Net.IPv4.To_Base_Integer (Val))
       and then Net.IPv4.Option.Available_Space (Ctx, Net.IPv4.Option.F_Option_Length) >= Net.IPv4.Option.Field_Size (Ctx, Net.IPv4.Option.F_Option_Length)
       and then Net.IPv4.Option.Field_Condition (Ctx, Net.IPv4.Option.F_Option_Length, Net.IPv4.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then Net.IPv4.Option.Has_Buffer (Ctx)
       and then Net.IPv4.Option.Valid_Next (Ctx, Net.IPv4.Option.F_Option_Data)
       and then Net.IPv4.Option.Available_Space (Ctx, Net.IPv4.Option.F_Option_Data) >= Net.IPv4.Option.Field_Size (Ctx, Net.IPv4.Option.F_Option_Data)
       and then Net.IPv4.Option.Field_Condition (Ctx, Net.IPv4.Option.F_Option_Data, 0)
       and then Net.IPv4.Option.Field_Size (Ctx, Net.IPv4.Option.F_Option_Data) = 0,
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then Net.IPv4.Option.Valid_Next (Ctx, Net.IPv4.Option.F_Option_Data)
       and then Net.IPv4.Option.Available_Space (Ctx, Net.IPv4.Option.F_Option_Data) >= Net.IPv4.Option.Field_Size (Ctx, Net.IPv4.Option.F_Option_Data)
       and then Net.IPv4.Option.Valid_Length (Ctx, Net.IPv4.Option.F_Option_Data, Data'Length)
       and then Net.IPv4.Option.Available_Space (Ctx, Net.IPv4.Option.F_Option_Data) >= Data'Length * RFLX_Types.Byte'Size
       and then Net.IPv4.Option.Field_Condition (Ctx, Net.IPv4.Option.F_Option_Data, 0),
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Option_Data)
   ...
   with
     Pre =>
       ...
       and then Net.IPv4.Option.Valid_Next (Ctx, Net.IPv4.Option.F_Option_Data)
       and then Net.IPv4.Option.Available_Space (Ctx, Net.IPv4.Option.F_Option_Data) >= Net.IPv4.Option.Field_Size (Ctx, Net.IPv4.Option.F_Option_Data)
       and then Net.IPv4.Option.Valid_Length (Ctx, Net.IPv4.Option.F_Option_Data, Length)
       and then RFLX_Types.To_Length (Net.IPv4.Option.Available_Space (Ctx, Net.IPv4.Option.F_Option_Data)) >= Length
...
private
   ...
   function Valid_Predecessors_Invariant (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return Boolean is
     ((if Well_Formed (Cursors (F_Copied)) then True)
      ...
      and then (if Well_Formed (Cursors (F_Option_Data)) then Valid (Cursors (F_Option_Length))))
   with
     Pre =>
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then Net.IPv4.Option.Field_First (Ctx, Net.IPv4.Option.F_Copied) rem RFLX_Types.Byte'Size = 1
   ...
   function Valid_Value (Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     (case Fld is
          when F_Copied =>
             Valid_Boolean (Val),
          when F_Option_Class =>
             Net.IPv4.Valid_Option_Class (Val),
          when F_Option_Number =>
             Net.IPv4.Valid_Option_Number (Val),
          when F_Option_Length =>
             Net.IPv4.Valid_Option_Length (Val),
          when F_Option_Data =>
             True);
   ...
   function Field_Condition (Ctx : Context; Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     (case Fld is
          when F_Copied | F_Option_Class =>
             True,
          when F_Option_Number =>
             (RFLX_Types.Base_Integer (Ctx.Cursors (F_Option_Class).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.IPv4.CONTROL))
              and then Val = 1)
             or else Val > 1,
          when F_Option_Length =>
             True,
          when F_Option_Data =>
             (RFLX_Types.Base_Integer (Ctx.Cursors (F_Option_Class).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.IPv4.DEBUGGING_AND_MEASUREMENT))
              and then Ctx.Cursors (F_Option_Number).Value = 4)
             or else (RFLX_Types.Base_Integer (Ctx.Cursors (F_Option_Class).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.IPv4.CONTROL))
             ...
             or else (Ctx.Cursors (F_Option_Length).Value = 11
                      and then RFLX_Types.Base_Integer (Ctx.Cursors (F_Option_Class).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.IPv4.CONTROL))
   ...
   function Well_Formed_Message (Ctx : Context) return Boolean is
     ((Well_Formed (Ctx, F_Option_Data)
       and then ((RFLX_Types.Base_Integer (Ctx.Cursors (F_Option_Class).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.IPv4.DEBUGGING_AND_MEASUREMENT))
                  and then Ctx.Cursors (F_Option_Number).Value = 4)
                 or else (RFLX_Types.Base_Integer (Ctx.Cursors (F_Option_Class).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.IPv4.CONTROL))
                          and then (Ctx.Cursors (F_Option_Number).Value = 9
                                    or else Ctx.Cursors (F_Option_Number).Value = 3
   ...
   function Get_Option_Class (Ctx : Context) return Net.IPv4.Option_Class is
     (To_Actual (Ctx.Cursors (F_Option_Class).Value));

   function Get_Option_Number (Ctx : Context) return Net.IPv4.Option_Number is
     (To_Actual (Ctx.Cursors (F_Option_Number).Value));

   function Get_Option_Length (Ctx : Context) return Net.IPv4.Option_Length is
