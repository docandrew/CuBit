...
is
   ...
   with
     Pre =>
       not Ctx'Constrained
       and Net.UDP.Datagram.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       Net.UDP.Datagram.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and then Buffer /= null
       and then Buffer'Length > 0
   ...
   with
     Pre =>
       Net.UDP.Datagram.Has_Buffer (Ctx)
       and then Net.UDP.Datagram.Well_Formed_Message (Ctx)
       and then Net.UDP.Datagram.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then Net.UDP.Datagram.Has_Buffer (Ctx)
       and then Offset < Net.UDP.Datagram.Buffer_Length (Ctx)
       and then Pre (Net.UDP.Datagram.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       Net.UDP.Datagram.Has_Buffer (Ctx)
       and then Net.UDP.Datagram.Well_Formed_Message (Ctx)
       and then Data'Length = Net.UDP.Datagram.Byte_Size (Ctx);
   ...
   with
     Pre =>
       Net.UDP.Datagram.Has_Buffer (Ctx)
       and then Net.UDP.Datagram.Valid_Next (Ctx, Fld)
       and then Net.UDP.Datagram.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   with
     Pre =>
       Net.UDP.Datagram.Valid_Next (Ctx, Fld),
     Post =>
       (case Fld is
           when F_Payload =>
   ...
   with
     Pre =>
       Net.UDP.Datagram.Has_Buffer (Ctx)
       and Net.UDP.Datagram.Valid_Next (Ctx, Fld);
   ...
   function Get_Source_Port (Ctx : Context) return Net.UDP.Port
   with
     Pre =>
       Net.UDP.Datagram.Valid (Ctx, Net.UDP.Datagram.F_Source_Port);

   function Get_Destination_Port (Ctx : Context) return Net.UDP.Port
   with
     Pre =>
       Net.UDP.Datagram.Valid (Ctx, Net.UDP.Datagram.F_Destination_Port);

   function Get_Length (Ctx : Context) return Net.UDP.Length
   with
     Pre =>
       Net.UDP.Datagram.Valid (Ctx, Net.UDP.Datagram.F_Length);

   function Get_Checksum (Ctx : Context) return Net.UDP.Checksum
   with
     Pre =>
       Net.UDP.Datagram.Valid (Ctx, Net.UDP.Datagram.F_Checksum);
   ...
   with
     ...
     Pre =>
       Net.UDP.Datagram.Has_Buffer (Ctx)
       and then Net.UDP.Datagram.Well_Formed (Ctx, Net.UDP.Datagram.F_Payload)
       and then Net.UDP.Datagram.Valid_Next (Ctx, Net.UDP.Datagram.F_Payload),
     Post =>
   ...
   with
     Pre =>
       ...
       and then Net.UDP.Datagram.Well_Formed (Ctx, Net.UDP.Datagram.F_Payload)
       and then Net.UDP.Datagram.Valid_Next (Ctx, Net.UDP.Datagram.F_Payload)
       and then Data'Length = RFLX_Types.To_Length (Net.UDP.Datagram.Field_Size (Ctx, Net.UDP.Datagram.F_Payload)),
     Post =>
   ...
   with
     Pre =>
       Net.UDP.Datagram.Has_Buffer (Ctx)
       and Net.UDP.Datagram.Present (Ctx, Net.UDP.Datagram.F_Payload);
   ...
   procedure Set_Source_Port (Ctx : in out Context; Val : Net.UDP.Port)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.UDP.Datagram.Has_Buffer (Ctx)
       and then Net.UDP.Datagram.Valid_Next (Ctx, Net.UDP.Datagram.F_Source_Port)
       and then Net.UDP.Valid_Port (Net.UDP.To_Base_Integer (Val))
       and then Net.UDP.Datagram.Available_Space (Ctx, Net.UDP.Datagram.F_Source_Port) >= Net.UDP.Datagram.Field_Size (Ctx, Net.UDP.Datagram.F_Source_Port)
       and then Net.UDP.Datagram.Field_Condition (Ctx, Net.UDP.Datagram.F_Source_Port),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Destination_Port (Ctx : in out Context; Val : Net.UDP.Port)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.UDP.Datagram.Has_Buffer (Ctx)
       and then Net.UDP.Datagram.Valid_Next (Ctx, Net.UDP.Datagram.F_Destination_Port)
       and then Net.UDP.Valid_Port (Net.UDP.To_Base_Integer (Val))
       and then Net.UDP.Datagram.Available_Space (Ctx, Net.UDP.Datagram.F_Destination_Port) >= Net.UDP.Datagram.Field_Size (Ctx, Net.UDP.Datagram.F_Destination_Port)
       and then Net.UDP.Datagram.Field_Condition (Ctx, Net.UDP.Datagram.F_Destination_Port),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Length (Ctx : in out Context; Val : Net.UDP.Length)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.UDP.Datagram.Has_Buffer (Ctx)
       and then Net.UDP.Datagram.Valid_Next (Ctx, Net.UDP.Datagram.F_Length)
       and then Net.UDP.Valid_Length (Net.UDP.To_Base_Integer (Val))
       and then Net.UDP.Datagram.Available_Space (Ctx, Net.UDP.Datagram.F_Length) >= Net.UDP.Datagram.Field_Size (Ctx, Net.UDP.Datagram.F_Length)
       and then Net.UDP.Datagram.Field_Condition (Ctx, Net.UDP.Datagram.F_Length),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Checksum (Ctx : in out Context; Val : Net.UDP.Checksum)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.UDP.Datagram.Has_Buffer (Ctx)
       and then Net.UDP.Datagram.Valid_Next (Ctx, Net.UDP.Datagram.F_Checksum)
       and then Net.UDP.Valid_Checksum (Net.UDP.To_Base_Integer (Val))
       and then Net.UDP.Datagram.Available_Space (Ctx, Net.UDP.Datagram.F_Checksum) >= Net.UDP.Datagram.Field_Size (Ctx, Net.UDP.Datagram.F_Checksum)
       and then Net.UDP.Datagram.Field_Condition (Ctx, Net.UDP.Datagram.F_Checksum),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then Net.UDP.Datagram.Has_Buffer (Ctx)
       and then Net.UDP.Datagram.Valid_Next (Ctx, Net.UDP.Datagram.F_Payload)
       and then Net.UDP.Datagram.Available_Space (Ctx, Net.UDP.Datagram.F_Payload) >= Net.UDP.Datagram.Field_Size (Ctx, Net.UDP.Datagram.F_Payload)
       and then Net.UDP.Datagram.Field_Condition (Ctx, Net.UDP.Datagram.F_Payload)
       and then Net.UDP.Datagram.Field_Size (Ctx, Net.UDP.Datagram.F_Payload) = 0,
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then Net.UDP.Datagram.Valid_Next (Ctx, Net.UDP.Datagram.F_Payload)
       and then Net.UDP.Datagram.Available_Space (Ctx, Net.UDP.Datagram.F_Payload) >= Net.UDP.Datagram.Field_Size (Ctx, Net.UDP.Datagram.F_Payload)
       and then Net.UDP.Datagram.Valid_Length (Ctx, Net.UDP.Datagram.F_Payload, Data'Length)
       and then Net.UDP.Datagram.Available_Space (Ctx, Net.UDP.Datagram.F_Payload) >= Data'Length * RFLX_Types.Byte'Size
       and then Net.UDP.Datagram.Field_Condition (Ctx, Net.UDP.Datagram.F_Payload),
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Payload)
   ...
   with
     Pre =>
       ...
       and then Net.UDP.Datagram.Valid_Next (Ctx, Net.UDP.Datagram.F_Payload)
       and then Net.UDP.Datagram.Available_Space (Ctx, Net.UDP.Datagram.F_Payload) >= Net.UDP.Datagram.Field_Size (Ctx, Net.UDP.Datagram.F_Payload)
       and then Net.UDP.Datagram.Valid_Length (Ctx, Net.UDP.Datagram.F_Payload, Length)
       and then RFLX_Types.To_Length (Net.UDP.Datagram.Available_Space (Ctx, Net.UDP.Datagram.F_Payload)) >= Length
   ...
   type Structure is
      record
         Source_Port : Net.UDP.Port;
         Destination_Port : Net.UDP.Port;
         Length : Net.UDP.Length;
         Checksum : Net.UDP.Checksum;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then Net.UDP.Datagram.Has_Buffer (Ctx)
       and then Net.UDP.Datagram.Valid_Structure (Struct)
       and then Net.UDP.Datagram.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
...
private
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then Net.UDP.Datagram.Field_First (Ctx, Net.UDP.Datagram.F_Source_Port) rem RFLX_Types.Byte'Size = 1
   ...
   function Valid_Value (Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     (case Fld is
          when F_Source_Port | F_Destination_Port =>
             Net.UDP.Valid_Port (Val),
          when F_Length =>
             Net.UDP.Valid_Length (Val),
          when F_Checksum =>
             Net.UDP.Valid_Checksum (Val),
          when F_Payload =>
             True);
   ...
   function Get_Source_Port (Ctx : Context) return Net.UDP.Port is
     (To_Actual (Ctx.Cursors (F_Source_Port).Value));

   function Get_Destination_Port (Ctx : Context) return Net.UDP.Port is
     (To_Actual (Ctx.Cursors (F_Destination_Port).Value));

   function Get_Length (Ctx : Context) return Net.UDP.Length is
     (To_Actual (Ctx.Cursors (F_Length).Value));

   function Get_Checksum (Ctx : Context) return Net.UDP.Checksum is
