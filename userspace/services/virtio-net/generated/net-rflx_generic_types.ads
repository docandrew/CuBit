...
package Net.RFLX_Generic_Types
with
  SPARK_Mode,
  Always_Terminates
is
   ...
   subtype U64 is Net.RFLX_Arithmetic.U64;

   subtype Base_Integer is Net.RFLX_Arithmetic.Base_Integer;
   ...
   procedure Lemma_Size (Val : Base_Integer; Size : Positive) renames Net.RFLX_Arithmetic.Lemma_Size;

   procedure Free is new Ada.Unchecked_Deallocation (Object => Bytes, Name => Bytes_Ptr);

end Net.RFLX_Generic_Types;
