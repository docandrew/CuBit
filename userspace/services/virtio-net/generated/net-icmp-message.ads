...
is
   ...
   with
     Pre =>
       not Ctx'Constrained
       and Net.ICMP.Message.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       Net.ICMP.Message.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and then Buffer /= null
       and then Buffer'Length > 0
   ...
   with
     Pre =>
       Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Well_Formed_Message (Ctx)
       and then Net.ICMP.Message.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then Net.ICMP.Message.Has_Buffer (Ctx)
       and then Offset < Net.ICMP.Message.Buffer_Length (Ctx)
       and then Pre (Net.ICMP.Message.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Well_Formed_Message (Ctx)
       and then Data'Length = Net.ICMP.Message.Byte_Size (Ctx);
   ...
   with
     Pre =>
       Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Valid_Value (Fld, Val)
       and then Net.ICMP.Message.Valid_Next (Ctx, Fld)
       and then Net.ICMP.Message.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   with
     Pre =>
       Net.ICMP.Message.Valid_Next (Ctx, Fld),
     Post =>
       (case Fld is
           when F_Data =>
   ...
   with
     Pre =>
       Net.ICMP.Message.Has_Buffer (Ctx)
       and Net.ICMP.Message.Valid_Next (Ctx, Fld);
   ...
   function Get_Tag (Ctx : Context) return Net.ICMP.Tag
   with
     Pre =>
       Net.ICMP.Message.Valid (Ctx, Net.ICMP.Message.F_Tag);

   function Get_Code_Destination_Unreachable (Ctx : Context) return Net.ICMP.Code_Destination_Unreachable
   with
     Pre =>
       Net.ICMP.Message.Valid (Ctx, Net.ICMP.Message.F_Code_Destination_Unreachable);

   function Get_Code_Redirect (Ctx : Context) return Net.ICMP.Code_Redirect
   with
     Pre =>
       Net.ICMP.Message.Valid (Ctx, Net.ICMP.Message.F_Code_Redirect);

   function Get_Code_Time_Exceeded (Ctx : Context) return Net.ICMP.Code_Time_Exceeded
   with
     Pre =>
       Net.ICMP.Message.Valid (Ctx, Net.ICMP.Message.F_Code_Time_Exceeded);

   function Get_Code_Zero (Ctx : Context) return Net.ICMP.Code_Zero
   with
     Pre =>
       Net.ICMP.Message.Valid (Ctx, Net.ICMP.Message.F_Code_Zero);

   function Get_Checksum (Ctx : Context) return Net.ICMP.Checksum
   with
     Pre =>
       Net.ICMP.Message.Valid (Ctx, Net.ICMP.Message.F_Checksum);

   function Get_Gateway_Internet_Address (Ctx : Context) return Net.ICMP.Gateway_Internet_Address
   with
     Pre =>
       Net.ICMP.Message.Valid (Ctx, Net.ICMP.Message.F_Gateway_Internet_Address);

   function Get_Identifier (Ctx : Context) return Net.ICMP.Identifier
   with
     Pre =>
       Net.ICMP.Message.Valid (Ctx, Net.ICMP.Message.F_Identifier);

   function Get_Pointer (Ctx : Context) return Net.ICMP.Pointer
   with
     Pre =>
       Net.ICMP.Message.Valid (Ctx, Net.ICMP.Message.F_Pointer);

   function Get_Unused_32 (Ctx : Context) return Net.ICMP.Unused_32
   with
     Pre =>
       Net.ICMP.Message.Valid (Ctx, Net.ICMP.Message.F_Unused_32);

   function Get_Sequence_Number (Ctx : Context) return Net.ICMP.Sequence_Number
   with
     Pre =>
       Net.ICMP.Message.Valid (Ctx, Net.ICMP.Message.F_Sequence_Number);

   function Get_Unused_24 (Ctx : Context) return Net.ICMP.Unused_24
   with
     Pre =>
       Net.ICMP.Message.Valid (Ctx, Net.ICMP.Message.F_Unused_24);

   function Get_Originate_Timestamp (Ctx : Context) return Net.ICMP.Timestamp
   with
     Pre =>
       Net.ICMP.Message.Valid (Ctx, Net.ICMP.Message.F_Originate_Timestamp);

   function Get_Receive_Timestamp (Ctx : Context) return Net.ICMP.Timestamp
   with
     Pre =>
       Net.ICMP.Message.Valid (Ctx, Net.ICMP.Message.F_Receive_Timestamp);

   function Get_Transmit_Timestamp (Ctx : Context) return Net.ICMP.Timestamp
   with
     Pre =>
       Net.ICMP.Message.Valid (Ctx, Net.ICMP.Message.F_Transmit_Timestamp);
   ...
   with
     ...
     Pre =>
       Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Well_Formed (Ctx, Net.ICMP.Message.F_Data)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Data),
     Post =>
   ...
   with
     Pre =>
       ...
       and then Net.ICMP.Message.Well_Formed (Ctx, Net.ICMP.Message.F_Data)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Data)
       and then Data'Length = RFLX_Types.To_Length (Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Data)),
     Post =>
   ...
   with
     Pre =>
       Net.ICMP.Message.Has_Buffer (Ctx)
       and Net.ICMP.Message.Present (Ctx, Net.ICMP.Message.F_Data);
   ...
   procedure Set_Tag (Ctx : in out Context; Val : Net.ICMP.Tag)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Tag)
       and then Net.ICMP.Valid_Tag (Net.ICMP.To_Base_Integer (Val))
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Tag) >= Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Tag)
       and then Net.ICMP.Message.Field_Condition (Ctx, Net.ICMP.Message.F_Tag, Net.ICMP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, F_Tag)
       and Get_Tag (Ctx) = Val
       ...
       and (if
               RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Destination_Unreachable))
            then
               Valid_Next (Ctx, F_Code_Destination_Unreachable))
       and (if
               RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Redirect))
            then
               Valid_Next (Ctx, F_Code_Redirect))
       and (if
               RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Time_Exceeded))
            then
               Valid_Next (Ctx, F_Code_Time_Exceeded))
       and (if
               RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Information_Reply))
               or else RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Information_Request))
               or else RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Timestamp_Reply))
               or else RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Timestamp_Msg))
               or else RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Parameter_Problem))
               or else RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Source_Quench))
               or else RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Echo_Reply))
               or else RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Echo_Request))
            then
   ...
   procedure Set_Code_Destination_Unreachable (Ctx : in out Context; Val : Net.ICMP.Code_Destination_Unreachable)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Code_Destination_Unreachable)
       and then Net.ICMP.Valid_Code_Destination_Unreachable (Net.ICMP.To_Base_Integer (Val))
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Code_Destination_Unreachable) >= Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Code_Destination_Unreachable)
       and then Net.ICMP.Message.Field_Condition (Ctx, Net.ICMP.Message.F_Code_Destination_Unreachable, Net.ICMP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Code_Redirect (Ctx : in out Context; Val : Net.ICMP.Code_Redirect)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Code_Redirect)
       and then Net.ICMP.Valid_Code_Redirect (Net.ICMP.To_Base_Integer (Val))
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Code_Redirect) >= Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Code_Redirect)
       and then Net.ICMP.Message.Field_Condition (Ctx, Net.ICMP.Message.F_Code_Redirect, Net.ICMP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Code_Time_Exceeded (Ctx : in out Context; Val : Net.ICMP.Code_Time_Exceeded)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Code_Time_Exceeded)
       and then Net.ICMP.Valid_Code_Time_Exceeded (Net.ICMP.To_Base_Integer (Val))
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Code_Time_Exceeded) >= Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Code_Time_Exceeded)
       and then Net.ICMP.Message.Field_Condition (Ctx, Net.ICMP.Message.F_Code_Time_Exceeded, Net.ICMP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Code_Zero (Ctx : in out Context; Val : Net.ICMP.Code_Zero)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Code_Zero)
       and then Net.ICMP.Valid_Code_Zero (Net.ICMP.To_Base_Integer (Val))
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Code_Zero) >= Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Code_Zero)
       and then Net.ICMP.Message.Field_Condition (Ctx, Net.ICMP.Message.F_Code_Zero, Net.ICMP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Checksum (Ctx : in out Context; Val : Net.ICMP.Checksum)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Checksum)
       and then Net.ICMP.Valid_Checksum (Net.ICMP.To_Base_Integer (Val))
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Checksum) >= Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Checksum)
       and then Net.ICMP.Message.Field_Condition (Ctx, Net.ICMP.Message.F_Checksum, Net.ICMP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
       ...
       and (if
               RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Parameter_Problem))
            then
               Valid_Next (Ctx, F_Pointer))
       and (if
               RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Time_Exceeded))
               or else RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Destination_Unreachable))
               or else RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Source_Quench))
            then
   ...
   procedure Set_Gateway_Internet_Address (Ctx : in out Context; Val : Net.ICMP.Gateway_Internet_Address)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Gateway_Internet_Address)
       and then Net.ICMP.Valid_Gateway_Internet_Address (Net.ICMP.To_Base_Integer (Val))
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Gateway_Internet_Address) >= Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Gateway_Internet_Address)
       and then Net.ICMP.Message.Field_Condition (Ctx, Net.ICMP.Message.F_Gateway_Internet_Address, Net.ICMP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Identifier (Ctx : in out Context; Val : Net.ICMP.Identifier)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Identifier)
       and then Net.ICMP.Valid_Identifier (Net.ICMP.To_Base_Integer (Val))
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Identifier) >= Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Identifier)
       and then Net.ICMP.Message.Field_Condition (Ctx, Net.ICMP.Message.F_Identifier, Net.ICMP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Pointer (Ctx : in out Context; Val : Net.ICMP.Pointer)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Pointer)
       and then Net.ICMP.Valid_Pointer (Net.ICMP.To_Base_Integer (Val))
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Pointer) >= Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Pointer)
       and then Net.ICMP.Message.Field_Condition (Ctx, Net.ICMP.Message.F_Pointer, Net.ICMP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Unused_32 (Ctx : in out Context; Val : Net.ICMP.Unused_32)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Unused_32)
       and then Net.ICMP.Valid_Unused_32 (Net.ICMP.To_Base_Integer (Val))
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Unused_32) >= Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Unused_32)
       and then Net.ICMP.Message.Field_Condition (Ctx, Net.ICMP.Message.F_Unused_32, Net.ICMP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Sequence_Number (Ctx : in out Context; Val : Net.ICMP.Sequence_Number)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Sequence_Number)
       and then Net.ICMP.Valid_Sequence_Number (Net.ICMP.To_Base_Integer (Val))
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Sequence_Number) >= Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Sequence_Number)
       and then Net.ICMP.Message.Field_Condition (Ctx, Net.ICMP.Message.F_Sequence_Number, Net.ICMP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
       ...
       and Invalid (Ctx, F_Transmit_Timestamp)
       and (if
               RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Echo_Reply))
               or else RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Echo_Request))
            then
               Valid_Next (Ctx, F_Data))
       and (if
               RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Timestamp_Msg))
               or else RFLX_Types.Base_Integer (To_Base_Integer (Get_Tag (Ctx))) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Timestamp_Reply))
            then
   ...
   procedure Set_Unused_24 (Ctx : in out Context; Val : Net.ICMP.Unused_24)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Unused_24)
       and then Net.ICMP.Valid_Unused_24 (Net.ICMP.To_Base_Integer (Val))
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Unused_24) >= Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Unused_24)
       and then Net.ICMP.Message.Field_Condition (Ctx, Net.ICMP.Message.F_Unused_24, Net.ICMP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Originate_Timestamp (Ctx : in out Context; Val : Net.ICMP.Timestamp)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Originate_Timestamp)
       and then Net.ICMP.Valid_Timestamp (Net.ICMP.To_Base_Integer (Val))
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Originate_Timestamp) >= Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Originate_Timestamp)
       and then Net.ICMP.Message.Field_Condition (Ctx, Net.ICMP.Message.F_Originate_Timestamp, Net.ICMP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Receive_Timestamp (Ctx : in out Context; Val : Net.ICMP.Timestamp)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Receive_Timestamp)
       and then Net.ICMP.Valid_Timestamp (Net.ICMP.To_Base_Integer (Val))
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Receive_Timestamp) >= Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Receive_Timestamp)
       and then Net.ICMP.Message.Field_Condition (Ctx, Net.ICMP.Message.F_Receive_Timestamp, Net.ICMP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Transmit_Timestamp (Ctx : in out Context; Val : Net.ICMP.Timestamp)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Transmit_Timestamp)
       and then Net.ICMP.Valid_Timestamp (Net.ICMP.To_Base_Integer (Val))
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Transmit_Timestamp) >= Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Transmit_Timestamp)
       and then Net.ICMP.Message.Field_Condition (Ctx, Net.ICMP.Message.F_Transmit_Timestamp, Net.ICMP.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Data)
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Data) >= Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Data)
       and then Net.ICMP.Message.Field_Condition (Ctx, Net.ICMP.Message.F_Data, 0)
       and then Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Data) = 0,
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then Net.ICMP.Message.Has_Buffer (Ctx)
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Data)
       and then Net.ICMP.Message.Valid_Length (Ctx, Net.ICMP.Message.F_Data, Length)
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Data) >= RFLX_Types.To_Bit_Length (Length),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then Net.ICMP.Message.Valid_Next (Ctx, Net.ICMP.Message.F_Data)
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Data) >= Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Data)
       and then Net.ICMP.Message.Valid_Length (Ctx, Net.ICMP.Message.F_Data, Data'Length)
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Data) >= Data'Length * RFLX_Types.Byte'Size
       and then Net.ICMP.Message.Field_Condition (Ctx, Net.ICMP.Message.F_Data, 0),
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Data)
   ...
   with
     Pre =>
       ...
       and then Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Data) >= Net.ICMP.Message.Field_Size (Ctx, Net.ICMP.Message.F_Data)
       and then Net.ICMP.Message.Valid_Length (Ctx, Net.ICMP.Message.F_Data, Length)
       and then RFLX_Types.To_Length (Net.ICMP.Message.Available_Space (Ctx, Net.ICMP.Message.F_Data)) >= Length
...
private
   ...
   function Valid_Predecessors_Invariant (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return Boolean is
     ((if Well_Formed (Cursors (F_Tag)) then True)
      and then (if
                ...
                then
                   (Valid (Cursors (F_Tag))
                    and then RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Destination_Unreachable))))
      and then (if
                   Well_Formed (Cursors (F_Code_Redirect))
                then
                   (Valid (Cursors (F_Tag))
                    and then RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Redirect))))
      and then (if
                   Well_Formed (Cursors (F_Code_Time_Exceeded))
                then
                   (Valid (Cursors (F_Tag))
                    and then RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Time_Exceeded))))
      and then (if
                   Well_Formed (Cursors (F_Code_Zero))
                then
                   (Valid (Cursors (F_Tag))
                    and then (RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Information_Reply))
                              or else RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Information_Request))
                              or else RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Timestamp_Reply))
                              or else RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Timestamp_Msg))
                              or else RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Parameter_Problem))
                              or else RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Source_Quench))
                              or else RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Echo_Reply))
                              or else RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Echo_Request)))))
      and then (if
      ...
      and then (if
                ...
                then
                   (Valid (Cursors (F_Checksum))
                    and then RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Parameter_Problem))))
      and then (if
                   Well_Formed (Cursors (F_Unused_32))
                then
                   (Valid (Cursors (F_Checksum))
                    and then (RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Time_Exceeded))
                              or else RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Destination_Unreachable))
                              or else RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Source_Quench)))))
      ...
      and then (if
                ...
                then
                   (Valid (Cursors (F_Sequence_Number))
                    and then (RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Timestamp_Msg))
                              or else RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Timestamp_Reply)))))
      and then (if
                ...
                then
                   ...
                   or (Valid (Cursors (F_Sequence_Number))
                       and then (RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Echo_Reply))
                                 or else RFLX_Types.Base_Integer (Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Echo_Request))))
          ...
          when F_Data =>
             (if
              ...
              then
                 ...
                 and then (RFLX_Types.Bit_Length (Cursors (F_Tag).Value) = RFLX_Types.Bit_Length (To_Base_Integer (Net.ICMP.Echo_Reply))
                           or else RFLX_Types.Bit_Length (Cursors (F_Tag).Value) = RFLX_Types.Bit_Length (To_Base_Integer (Net.ICMP.Echo_Request)))
              then
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then Net.ICMP.Message.Field_First (Ctx, Net.ICMP.Message.F_Tag) rem RFLX_Types.Byte'Size = 1
   ...
   function Valid_Value (Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     (case Fld is
          when F_Tag =>
             Net.ICMP.Valid_Tag (Val),
          when F_Code_Destination_Unreachable =>
             Net.ICMP.Valid_Code_Destination_Unreachable (Val),
          when F_Code_Redirect =>
             Net.ICMP.Valid_Code_Redirect (Val),
          when F_Code_Time_Exceeded =>
             Net.ICMP.Valid_Code_Time_Exceeded (Val),
          when F_Code_Zero =>
             Net.ICMP.Valid_Code_Zero (Val),
          when F_Checksum =>
             Net.ICMP.Valid_Checksum (Val),
          when F_Gateway_Internet_Address =>
             Net.ICMP.Valid_Gateway_Internet_Address (Val),
          when F_Identifier =>
             Net.ICMP.Valid_Identifier (Val),
          when F_Pointer =>
             Net.ICMP.Valid_Pointer (Val),
          when F_Unused_32 =>
             Net.ICMP.Valid_Unused_32 (Val),
          when F_Sequence_Number =>
             Net.ICMP.Valid_Sequence_Number (Val),
          when F_Unused_24 =>
             Net.ICMP.Valid_Unused_24 (Val),
          when F_Originate_Timestamp =>
             Net.ICMP.Valid_Timestamp (Val),
          when F_Data =>
             True,
          when F_Receive_Timestamp | F_Transmit_Timestamp =>
             Net.ICMP.Valid_Timestamp (Val));
   ...
   function Field_Condition (Ctx : Context; Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     (case Fld is
          when F_Tag =>
             Val = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Destination_Unreachable))
             or else Val = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Redirect))
             or else Val = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Time_Exceeded))
             or else Val = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Information_Reply))
             or else Val = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Information_Request))
             or else Val = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Timestamp_Reply))
             or else Val = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Timestamp_Msg))
             or else Val = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Parameter_Problem))
             or else Val = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Source_Quench))
             or else Val = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Echo_Reply))
             or else Val = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Echo_Request)),
          when F_Code_Destination_Unreachable | F_Code_Redirect | F_Code_Time_Exceeded | F_Code_Zero =>
             True,
          when F_Checksum =>
             RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Redirect))
             or else RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Parameter_Problem))
             or else RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Information_Reply))
             or else RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Information_Request))
             or else RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Timestamp_Reply))
             or else RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Timestamp_Msg))
             or else RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Echo_Request))
             or else RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Echo_Reply))
             or else RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Time_Exceeded))
             or else RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Destination_Unreachable))
             or else RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Source_Quench)),
          when F_Gateway_Internet_Address | F_Identifier | F_Pointer | F_Unused_32 =>
             True,
          when F_Sequence_Number =>
             RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Echo_Reply))
             or else RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Echo_Request))
             or else RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Information_Request))
             or else RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Information_Reply))
             or else RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Timestamp_Msg))
   ...
   function Well_Formed_Message (Ctx : Context) return Boolean is
     (Well_Formed (Ctx, F_Data)
      or else (Valid (Ctx, F_Sequence_Number)
               and then (RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Information_Request))
                         or else RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Integer (Net.ICMP.Information_Reply))))
   ...
   function Get_Tag (Ctx : Context) return Net.ICMP.Tag is
     (To_Actual (Ctx.Cursors (F_Tag).Value));

   function Get_Code_Destination_Unreachable (Ctx : Context) return Net.ICMP.Code_Destination_Unreachable is
     (To_Actual (Ctx.Cursors (F_Code_Destination_Unreachable).Value));

   function Get_Code_Redirect (Ctx : Context) return Net.ICMP.Code_Redirect is
     (To_Actual (Ctx.Cursors (F_Code_Redirect).Value));

   function Get_Code_Time_Exceeded (Ctx : Context) return Net.ICMP.Code_Time_Exceeded is
     (To_Actual (Ctx.Cursors (F_Code_Time_Exceeded).Value));

   function Get_Code_Zero (Ctx : Context) return Net.ICMP.Code_Zero is
     (To_Actual (Ctx.Cursors (F_Code_Zero).Value));

   function Get_Checksum (Ctx : Context) return Net.ICMP.Checksum is
     (To_Actual (Ctx.Cursors (F_Checksum).Value));

   function Get_Gateway_Internet_Address (Ctx : Context) return Net.ICMP.Gateway_Internet_Address is
     (To_Actual (Ctx.Cursors (F_Gateway_Internet_Address).Value));

   function Get_Identifier (Ctx : Context) return Net.ICMP.Identifier is
     (To_Actual (Ctx.Cursors (F_Identifier).Value));

   function Get_Pointer (Ctx : Context) return Net.ICMP.Pointer is
     (To_Actual (Ctx.Cursors (F_Pointer).Value));

   function Get_Unused_32 (Ctx : Context) return Net.ICMP.Unused_32 is
     (To_Actual (Ctx.Cursors (F_Unused_32).Value));

   function Get_Sequence_Number (Ctx : Context) return Net.ICMP.Sequence_Number is
     (To_Actual (Ctx.Cursors (F_Sequence_Number).Value));

   function Get_Unused_24 (Ctx : Context) return Net.ICMP.Unused_24 is
     (To_Actual (Ctx.Cursors (F_Unused_24).Value));

   function Get_Originate_Timestamp (Ctx : Context) return Net.ICMP.Timestamp is
     (To_Actual (Ctx.Cursors (F_Originate_Timestamp).Value));

   function Get_Receive_Timestamp (Ctx : Context) return Net.ICMP.Timestamp is
     (To_Actual (Ctx.Cursors (F_Receive_Timestamp).Value));

   function Get_Transmit_Timestamp (Ctx : Context) return Net.ICMP.Timestamp is
   ...
   function Valid_Size (Ctx : Context; Fld : Field; Size : RFLX_Types.Bit_Length) return Boolean is
     (if
          Fld = F_Data
          and then (RFLX_Types.Bit_Length (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Bit_Length (To_Base_Integer (Net.ICMP.Echo_Reply))
                    or else RFLX_Types.Bit_Length (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Bit_Length (To_Base_Integer (Net.ICMP.Echo_Request)))
       then
