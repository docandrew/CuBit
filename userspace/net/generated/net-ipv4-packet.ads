...
with Net.Protocol_Numbers;
use Net.Protocol_Numbers;
with Net.IPv4.Options;

package Net.IPv4.Packet
with
  SPARK_Mode,
  Always_Terminates
is
   ...
   with
     Pre =>
       not Ctx'Constrained
       and Net.IPv4.Packet.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       Net.IPv4.Packet.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and then Buffer /= null
       and then Buffer'Length > 0
   ...
   with
     Pre =>
       Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Well_Formed_Message (Ctx)
       and then Net.IPv4.Packet.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Offset < Net.IPv4.Packet.Buffer_Length (Ctx)
       and then Pre (Net.IPv4.Packet.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Well_Formed_Message (Ctx)
       and then Data'Length = Net.IPv4.Packet.Byte_Size (Ctx);
   ...
   with
     Pre =>
       Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Valid_Value (Fld, Val)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Fld)
       and then Net.IPv4.Packet.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   with
     Pre =>
       Net.IPv4.Packet.Valid_Next (Ctx, Fld),
     Post =>
       (case Fld is
   ...
   with
     Pre =>
       Net.IPv4.Packet.Has_Buffer (Ctx)
       and Net.IPv4.Packet.Valid_Next (Ctx, Fld);
   ...
   function Get_Version (Ctx : Context) return Net.IPv4.Version
   with
     Pre =>
       Net.IPv4.Packet.Valid (Ctx, Net.IPv4.Packet.F_Version);

   function Get_IHL (Ctx : Context) return Net.IPv4.IHL
   with
     Pre =>
       Net.IPv4.Packet.Valid (Ctx, Net.IPv4.Packet.F_IHL);

   function Get_DSCP (Ctx : Context) return Net.IPv4.DCSP
   with
     Pre =>
       Net.IPv4.Packet.Valid (Ctx, Net.IPv4.Packet.F_DSCP);

   function Get_ECN (Ctx : Context) return Net.IPv4.ECN
   with
     Pre =>
       Net.IPv4.Packet.Valid (Ctx, Net.IPv4.Packet.F_ECN);

   function Get_Total_Length (Ctx : Context) return Net.IPv4.Total_Length
   with
     Pre =>
       Net.IPv4.Packet.Valid (Ctx, Net.IPv4.Packet.F_Total_Length);

   function Get_Identification (Ctx : Context) return Net.IPv4.Identification
   with
     Pre =>
       Net.IPv4.Packet.Valid (Ctx, Net.IPv4.Packet.F_Identification);

   function Get_Flag_R (Ctx : Context) return Boolean
   with
     Pre =>
       Net.IPv4.Packet.Valid (Ctx, Net.IPv4.Packet.F_Flag_R);

   function Get_Flag_DF (Ctx : Context) return Boolean
   with
     Pre =>
       Net.IPv4.Packet.Valid (Ctx, Net.IPv4.Packet.F_Flag_DF);

   function Get_Flag_MF (Ctx : Context) return Boolean
   with
     Pre =>
       Net.IPv4.Packet.Valid (Ctx, Net.IPv4.Packet.F_Flag_MF);

   function Get_Fragment_Offset (Ctx : Context) return Net.IPv4.Fragment_Offset
   with
     Pre =>
       Net.IPv4.Packet.Valid (Ctx, Net.IPv4.Packet.F_Fragment_Offset);

   function Get_TTL (Ctx : Context) return Net.IPv4.TTL
   with
     Pre =>
       Net.IPv4.Packet.Valid (Ctx, Net.IPv4.Packet.F_TTL);

   function Get_Protocol (Ctx : Context) return Net.Protocol_Numbers.Assigned_Internet_Protocol_Numbers
   with
     Pre =>
       Net.IPv4.Packet.Valid (Ctx, Net.IPv4.Packet.F_Protocol);

   function Get_Header_Checksum (Ctx : Context) return Net.IPv4.Header_Checksum
   with
     Pre =>
       Net.IPv4.Packet.Valid (Ctx, Net.IPv4.Packet.F_Header_Checksum);

   function Get_Source (Ctx : Context) return Net.IPv4.Address
   with
     Pre =>
       Net.IPv4.Packet.Valid (Ctx, Net.IPv4.Packet.F_Source);

   function Get_Destination (Ctx : Context) return Net.IPv4.Address
   with
     Pre =>
       Net.IPv4.Packet.Valid (Ctx, Net.IPv4.Packet.F_Destination);
   ...
   with
     ...
     Pre =>
       Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Well_Formed (Ctx, Net.IPv4.Packet.F_Payload)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Payload),
     Post =>
   ...
   with
     Pre =>
       ...
       and then Net.IPv4.Packet.Well_Formed (Ctx, Net.IPv4.Packet.F_Payload)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Payload)
       and then Data'Length = RFLX_Types.To_Length (Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Payload)),
     Post =>
   ...
   with
     Pre =>
       Net.IPv4.Packet.Has_Buffer (Ctx)
       and Net.IPv4.Packet.Present (Ctx, Net.IPv4.Packet.F_Payload);
   ...
   procedure Set_Version (Ctx : in out Context; Val : Net.IPv4.Version)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Version)
       and then Net.IPv4.Valid_Version (Net.IPv4.To_Base_Integer (Val))
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Version) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Version)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_Version, Net.IPv4.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_IHL (Ctx : in out Context; Val : Net.IPv4.IHL)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_IHL)
       and then Net.IPv4.Valid_IHL (Net.IPv4.To_Base_Integer (Val))
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_IHL) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_IHL)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_IHL, Net.IPv4.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, F_IHL)
       and Get_IHL (Ctx) = Val
   ...
   procedure Set_DSCP (Ctx : in out Context; Val : Net.IPv4.DCSP)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_DSCP)
       and then Net.IPv4.Valid_DCSP (Net.IPv4.To_Base_Integer (Val))
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_DSCP) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_DSCP)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_DSCP, Net.IPv4.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_ECN (Ctx : in out Context; Val : Net.IPv4.ECN)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_ECN)
       and then Net.IPv4.Valid_ECN (Net.IPv4.To_Base_Integer (Val))
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_ECN) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_ECN)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_ECN, Net.IPv4.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, F_ECN)
       and Get_ECN (Ctx) = Val
   ...
   procedure Set_Total_Length (Ctx : in out Context; Val : Net.IPv4.Total_Length)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Total_Length)
       and then Net.IPv4.Valid_Total_Length (Net.IPv4.To_Base_Integer (Val))
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Total_Length) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Total_Length)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_Total_Length, Net.IPv4.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Identification (Ctx : in out Context; Val : Net.IPv4.Identification)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Identification)
       and then Net.IPv4.Valid_Identification (Net.IPv4.To_Base_Integer (Val))
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Identification) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Identification)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_Identification, Net.IPv4.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     ...
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Flag_R)
       and then Valid_Boolean (To_Base_Integer (Val))
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Flag_R) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Flag_R)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_Flag_R, To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     ...
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Flag_DF)
       and then Valid_Boolean (To_Base_Integer (Val))
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Flag_DF) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Flag_DF)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_Flag_DF, To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     ...
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Flag_MF)
       and then Valid_Boolean (To_Base_Integer (Val))
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Flag_MF) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Flag_MF)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_Flag_MF, To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Fragment_Offset (Ctx : in out Context; Val : Net.IPv4.Fragment_Offset)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Fragment_Offset)
       and then Net.IPv4.Valid_Fragment_Offset (Net.IPv4.To_Base_Integer (Val))
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Fragment_Offset) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Fragment_Offset)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_Fragment_Offset, Net.IPv4.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_TTL (Ctx : in out Context; Val : Net.IPv4.TTL)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_TTL)
       and then Net.IPv4.Valid_TTL (Net.IPv4.To_Base_Integer (Val))
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_TTL) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_TTL)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_TTL, Net.IPv4.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, F_TTL)
       and Get_TTL (Ctx) = Val
   ...
   procedure Set_Protocol (Ctx : in out Context; Val : Net.Protocol_Numbers.Assigned_Internet_Protocol_Numbers_Enum)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Protocol)
       and then Net.Protocol_Numbers.Valid_Assigned_Internet_Protocol_Numbers (Net.Protocol_Numbers.To_Base_Integer (Val))
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Protocol) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Protocol)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_Protocol, Net.Protocol_Numbers.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Header_Checksum (Ctx : in out Context; Val : Net.IPv4.Header_Checksum)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Header_Checksum)
       and then Net.IPv4.Valid_Header_Checksum (Net.IPv4.To_Base_Integer (Val))
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Header_Checksum) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Header_Checksum)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_Header_Checksum, Net.IPv4.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Source (Ctx : in out Context; Val : Net.IPv4.Address)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Source)
       and then Net.IPv4.Valid_Address (Net.IPv4.To_Base_Integer (Val))
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Source) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Source)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_Source, Net.IPv4.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Destination (Ctx : in out Context; Val : Net.IPv4.Address)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Destination)
       and then Net.IPv4.Valid_Address (Net.IPv4.To_Base_Integer (Val))
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Destination) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Destination)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_Destination, Net.IPv4.To_Base_Integer (Val)),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Options)
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Options) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Options)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_Options, 0)
       and then Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Options) = 0,
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       ...
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Payload)
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Payload) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Payload)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_Payload, 0)
       and then Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Payload) = 0,
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Options (Ctx : in out Context; Seq_Ctx : Net.IPv4.Options.Context)
   with
     Pre =>
       not Ctx'Constrained
       and then Net.IPv4.Packet.Has_Buffer (Ctx)
       ...
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Options) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Options)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_Options, 0)
       and then Net.IPv4.Packet.Valid_Length (Ctx, Net.IPv4.Packet.F_Options, Net.IPv4.Options.Byte_Size (Seq_Ctx))
       and then Net.IPv4.Options.Has_Buffer (Seq_Ctx)
       and then Net.IPv4.Options.Valid (Seq_Ctx),
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Options)
       and Invalid (Ctx, F_Payload)
   ...
   with
     Pre =>
       ...
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Payload)
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Payload) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Payload)
       and then Net.IPv4.Packet.Valid_Length (Ctx, Net.IPv4.Packet.F_Payload, Data'Length)
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Payload) >= Data'Length * RFLX_Types.Byte'Size
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_Payload, 0),
     Post =>
       Has_Buffer (Ctx)
       and Well_Formed (Ctx, F_Payload)
   ...
   with
     Pre =>
       ...
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Payload)
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Payload) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Payload)
       and then Net.IPv4.Packet.Valid_Length (Ctx, Net.IPv4.Packet.F_Payload, Length)
       and then RFLX_Types.To_Length (Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Payload)) >= Length
   ...
   procedure Switch_To_Options (Ctx : in out Context; Seq_Ctx : out Net.IPv4.Options.Context)
   with
     Pre =>
       not Ctx'Constrained
       ...
       and then Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Options)
       and then Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Options) > 0
       and then Net.IPv4.Packet.Field_First (Ctx, Net.IPv4.Packet.F_Options) rem RFLX_Types.Byte'Size = 1
       and then Net.IPv4.Packet.Available_Space (Ctx, Net.IPv4.Packet.F_Options) >= Net.IPv4.Packet.Field_Size (Ctx, Net.IPv4.Packet.F_Options)
       and then Net.IPv4.Packet.Field_Condition (Ctx, Net.IPv4.Packet.F_Options, 0),
     Post =>
       not Net.IPv4.Packet.Has_Buffer (Ctx)
       and Net.IPv4.Options.Has_Buffer (Seq_Ctx)
       ...
       and Net.IPv4.Options.Valid (Seq_Ctx)
       and Net.IPv4.Options.Sequence_Last (Seq_Ctx) = Seq_Ctx.First - 1
   ...
   function Complete_Options (Ctx : Context; Seq_Ctx : Net.IPv4.Options.Context) return Boolean
   with
     Pre =>
       Net.IPv4.Packet.Valid_Next (Ctx, Net.IPv4.Packet.F_Options);

   procedure Update_Options (Ctx : in out Context; Seq_Ctx : in out Net.IPv4.Options.Context)
   with
     Pre =>
       Net.IPv4.Packet.Present (Ctx, Net.IPv4.Packet.F_Options)
       and then not Net.IPv4.Packet.Has_Buffer (Ctx)
       and then Net.IPv4.Options.Has_Buffer (Seq_Ctx)
     ...
     Post =>
       (if
           Net.IPv4.Packet.Complete_Options (Ctx, Seq_Ctx)
        then
           ...
           and Invalid (Ctx, F_Payload))
       and Has_Buffer (Ctx)
       and not Net.IPv4.Options.Has_Buffer (Seq_Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and Ctx.First = Ctx.First'Old
       and Ctx.Last = Ctx.Last'Old
       ...
       and Net.IPv4.Options.Valid (Seq_Ctx) = Net.IPv4.Options.Valid (Seq_Ctx)'Old
       and Net.IPv4.Options.Size (Seq_Ctx) = Net.IPv4.Options.Size (Seq_Ctx)'Old
       and Field_First (Ctx, F_Options) = Field_First (Ctx, F_Options)'Old
...
private
   ...
   function Field_Size_Internal (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length; Fld : Field) return RFLX_Types.Bit_Length'Base is
     (case Fld is
          ...
          when F_Source | F_Destination =>
             32,
          when F_Options =>
             RFLX_Types.Bit_Length (Cursors (F_IHL).Value) * 32 + (-RFLX_Types.Bit_Length (Cursors (F_Destination).Last) + RFLX_Types.Bit_Length (First) - 1),
          when F_Payload =>
     ...
     ((if
      ...
      and then ((if
                ...
                and then (if
                             Well_Formed (Cursors (F_Options))
                          then
                             (Cursors (F_Options).Last - Cursors (F_Options).First + 1 = RFLX_Types.Bit_Length (Cursors (F_IHL).Value) * 32 + (-RFLX_Types.Bit_Length (Cursors (F_Destination).Last) + RFLX_Types.Bit_Length (First) - 1)
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then Net.IPv4.Packet.Field_First (Ctx, Net.IPv4.Packet.F_Version) rem RFLX_Types.Byte'Size = 1
   ...
   function Valid_Value (Fld : Field; Val : RFLX_Types.Base_Integer) return Boolean is
     (case Fld is
          when F_Version =>
             Net.IPv4.Valid_Version (Val),
          when F_IHL =>
             Net.IPv4.Valid_IHL (Val),
          when F_DSCP =>
             Net.IPv4.Valid_DCSP (Val),
          when F_ECN =>
             Net.IPv4.Valid_ECN (Val),
          when F_Total_Length =>
             Net.IPv4.Valid_Total_Length (Val),
          when F_Identification =>
             Net.IPv4.Valid_Identification (Val),
          when F_Flag_R | F_Flag_DF | F_Flag_MF =>
             Valid_Boolean (Val),
          when F_Fragment_Offset =>
             Net.IPv4.Valid_Fragment_Offset (Val),
          when F_TTL =>
             Net.IPv4.Valid_TTL (Val),
          when F_Protocol =>
             Net.Protocol_Numbers.Valid_Assigned_Internet_Protocol_Numbers (Val),
          when F_Header_Checksum =>
             Net.IPv4.Valid_Header_Checksum (Val),
          when F_Source | F_Destination =>
   ...
   function Get_Version (Ctx : Context) return Net.IPv4.Version is
     (To_Actual (Ctx.Cursors (F_Version).Value));

   function Get_IHL (Ctx : Context) return Net.IPv4.IHL is
     (To_Actual (Ctx.Cursors (F_IHL).Value));

   function Get_DSCP (Ctx : Context) return Net.IPv4.DCSP is
     (To_Actual (Ctx.Cursors (F_DSCP).Value));

   function Get_ECN (Ctx : Context) return Net.IPv4.ECN is
     (To_Actual (Ctx.Cursors (F_ECN).Value));

   function Get_Total_Length (Ctx : Context) return Net.IPv4.Total_Length is
     (To_Actual (Ctx.Cursors (F_Total_Length).Value));

   function Get_Identification (Ctx : Context) return Net.IPv4.Identification is
   ...
   function Get_Fragment_Offset (Ctx : Context) return Net.IPv4.Fragment_Offset is
     (To_Actual (Ctx.Cursors (F_Fragment_Offset).Value));

   function Get_TTL (Ctx : Context) return Net.IPv4.TTL is
     (To_Actual (Ctx.Cursors (F_TTL).Value));

   function Get_Protocol (Ctx : Context) return Net.Protocol_Numbers.Assigned_Internet_Protocol_Numbers is
     (To_Actual (Ctx.Cursors (F_Protocol).Value));

   function Get_Header_Checksum (Ctx : Context) return Net.IPv4.Header_Checksum is
     (To_Actual (Ctx.Cursors (F_Header_Checksum).Value));

   function Get_Source (Ctx : Context) return Net.IPv4.Address is
     (To_Actual (Ctx.Cursors (F_Source).Value));

   function Get_Destination (Ctx : Context) return Net.IPv4.Address is
   ...
   function Complete_Options (Ctx : Context; Seq_Ctx : Net.IPv4.Options.Context) return Boolean is
     (Net.IPv4.Options.Valid (Seq_Ctx)
      and Net.IPv4.Options.Size (Seq_Ctx) = Field_Size (Ctx, F_Options));
