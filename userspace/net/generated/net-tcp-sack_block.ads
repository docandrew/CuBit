...
is
   ...
   type Virtual_Field is (F_Initial, F_Left_Edge, F_Right_Edge, F_Final);

   subtype Field is Virtual_Field range F_Left_Edge .. F_Right_Edge;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and Net.TCP.SACK_Block.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   with
     Pre =>
       Net.TCP.SACK_Block.Has_Buffer (Ctx),
     Post =>
       not Has_Buffer (Ctx)
       and then Buffer /= null
       and then Buffer'Length > 0
   ...
   with
     Pre =>
       Net.TCP.SACK_Block.Has_Buffer (Ctx)
       and then Net.TCP.SACK_Block.Well_Formed_Message (Ctx)
       and then Net.TCP.SACK_Block.Byte_Size (Ctx) = Buffer'Length;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then Net.TCP.SACK_Block.Has_Buffer (Ctx)
       and then Offset < Net.TCP.SACK_Block.Buffer_Length (Ctx)
       and then Pre (Net.TCP.SACK_Block.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   with
     Pre =>
       Net.TCP.SACK_Block.Has_Buffer (Ctx)
       and then Net.TCP.SACK_Block.Well_Formed_Message (Ctx)
       and then Data'Length = Net.TCP.SACK_Block.Byte_Size (Ctx);
   ...
   with
     Pre =>
       Net.TCP.SACK_Block.Has_Buffer (Ctx)
       and then Net.TCP.SACK_Block.Valid_Next (Ctx, Fld)
       and then Net.TCP.SACK_Block.Sufficient_Space (Ctx, Fld),
     Post =>
       True;
   ...
   with
     Pre =>
       Net.TCP.SACK_Block.Valid_Next (Ctx, Fld);
   ...
   function Get_Left_Edge (Ctx : Context) return Net.TCP.SACK_Edge
   with
     Pre =>
       Net.TCP.SACK_Block.Valid (Ctx, Net.TCP.SACK_Block.F_Left_Edge);

   function Get_Right_Edge (Ctx : Context) return Net.TCP.SACK_Edge
   with
     Pre =>
       Net.TCP.SACK_Block.Valid (Ctx, Net.TCP.SACK_Block.F_Right_Edge);
   ...
   procedure Set_Left_Edge (Ctx : in out Context; Val : Net.TCP.SACK_Edge)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.TCP.SACK_Block.Has_Buffer (Ctx)
       and then Net.TCP.SACK_Block.Valid_Next (Ctx, Net.TCP.SACK_Block.F_Left_Edge)
       and then Net.TCP.Valid_SACK_Edge (Net.TCP.To_Base_Integer (Val))
       and then Net.TCP.SACK_Block.Available_Space (Ctx, Net.TCP.SACK_Block.F_Left_Edge) >= Net.TCP.SACK_Block.Field_Size (Ctx, Net.TCP.SACK_Block.F_Left_Edge)
       and then Net.TCP.SACK_Block.Field_Condition (Ctx, Net.TCP.SACK_Block.F_Left_Edge),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, F_Left_Edge)
       and Get_Left_Edge (Ctx) = Val
       and Invalid (Ctx, F_Right_Edge)
       and Valid_Next (Ctx, F_Right_Edge)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and Ctx.First = Ctx.First'Old
       and Ctx.Last = Ctx.Last'Old
       and Valid_Next (Ctx, F_Left_Edge) = Valid_Next (Ctx, F_Left_Edge)'Old
       and Field_First (Ctx, F_Left_Edge) = Field_First (Ctx, F_Left_Edge)'Old;

   procedure Set_Right_Edge (Ctx : in out Context; Val : Net.TCP.SACK_Edge)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then Net.TCP.SACK_Block.Has_Buffer (Ctx)
       and then Net.TCP.SACK_Block.Valid_Next (Ctx, Net.TCP.SACK_Block.F_Right_Edge)
       and then Net.TCP.Valid_SACK_Edge (Net.TCP.To_Base_Integer (Val))
       and then Net.TCP.SACK_Block.Available_Space (Ctx, Net.TCP.SACK_Block.F_Right_Edge) >= Net.TCP.SACK_Block.Field_Size (Ctx, Net.TCP.SACK_Block.F_Right_Edge)
       and then Net.TCP.SACK_Block.Field_Condition (Ctx, Net.TCP.SACK_Block.F_Right_Edge),
     Post =>
       Has_Buffer (Ctx)
       and Valid (Ctx, F_Right_Edge)
       and Get_Right_Edge (Ctx) = Val
       and (if Well_Formed_Message (Ctx) then Message_Last (Ctx) = Field_Last (Ctx, F_Right_Edge))
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
       and Ctx.First = Ctx.First'Old
       and Ctx.Last = Ctx.Last'Old
       and Valid_Next (Ctx, F_Right_Edge) = Valid_Next (Ctx, F_Right_Edge)'Old
       and Get_Left_Edge (Ctx) = Get_Left_Edge (Ctx)'Old
       and Field_First (Ctx, F_Right_Edge) = Field_First (Ctx, F_Right_Edge)'Old
       and (for all F in Field range F_Left_Edge .. F_Left_Edge =>
   ...
   type Structure is
      record
         Left_Edge : Net.TCP.SACK_Edge;
         Right_Edge : Net.TCP.SACK_Edge;
      end record;
   ...
   with
     Pre =>
       not Ctx'Constrained
       and then Net.TCP.SACK_Block.Has_Buffer (Ctx)
       and then Net.TCP.SACK_Block.Valid_Structure (Struct)
       and then Net.TCP.SACK_Block.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
   ...
   function Field_Size_Left_Edge (Struct : Structure) return RFLX_Types.Bit_Length
   with
     Pre =>
       Valid_Structure (Struct);

   function Field_Size_Right_Edge (Struct : Structure) return RFLX_Types.Bit_Length
   with
     Pre =>
       Valid_Structure (Struct);
...
private
   ...
   function Valid_Predecessors_Invariant (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return Boolean is
     ((if Well_Formed (Cursors (F_Left_Edge)) then True)
      and then (if Well_Formed (Cursors (F_Right_Edge)) then Valid (Cursors (F_Left_Edge))))
   with
     Pre =>
   ...
   function Field_First_Left_Edge (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return RFLX_Types.Bit_Index'Base is
     (First)
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
       and then Valid_Next_Internal (Cursors, First, Verified_Last, Written_Last, F_Left_Edge);

   function Field_First_Right_Edge (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return RFLX_Types.Bit_Index'Base is
     (First + 32)
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
       and then Valid_Next_Internal (Cursors, First, Verified_Last, Written_Last, F_Right_Edge);
   ...
   function Field_First_Internal (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length; Fld : Field) return RFLX_Types.Bit_Index'Base is
     (case Fld is
          when F_Left_Edge =>
             Field_First_Left_Edge (Cursors, First, Verified_Last, Written_Last),
          when F_Right_Edge =>
             Field_First_Right_Edge (Cursors, First, Verified_Last, Written_Last))
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
   ...
   function Valid_Context (Buffer_First, Buffer_Last : RFLX_Types.Index; First : RFLX_Types.Bit_Index; Last : RFLX_Types.Bit_Length; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length; Buffer : RFLX_Types.Bytes_Ptr; Cursors : Field_Cursors) return Boolean is
     ((if
      ...
      and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
      and then ((if
                    Well_Formed (Cursors (F_Left_Edge))
                 then
                    (Cursors (F_Left_Edge).Last - Cursors (F_Left_Edge).First + 1 = 32
                     and then Cursors (F_Left_Edge).First = First))
                and then (if
                             Well_Formed (Cursors (F_Right_Edge))
                          then
                             (Cursors (F_Right_Edge).Last - Cursors (F_Right_Edge).First + 1 = 32
                              and then Cursors (F_Right_Edge).First = Cursors (F_Left_Edge).Last + 1))))
   with
     Post =>
       True;
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      and then Valid_Next (Ctx, F_Left_Edge)
      and then Net.TCP.SACK_Block.Field_First (Ctx, Net.TCP.SACK_Block.F_Left_Edge) rem RFLX_Types.Byte'Size = 1
      and then Available_Space (Ctx, F_Left_Edge) = Ctx.Last - Ctx.First + 1
   ...
   function Get_Left_Edge (Ctx : Context) return Net.TCP.SACK_Edge is
     (To_Actual (Ctx.Cursors (F_Left_Edge).Value));

   function Get_Right_Edge (Ctx : Context) return Net.TCP.SACK_Edge is
     (To_Actual (Ctx.Cursors (F_Right_Edge).Value));
   ...
   function Field_Size_Left_Edge (Struct : Structure) return RFLX_Types.Bit_Length is
     (32);

   function Field_Size_Right_Edge (Struct : Structure) return RFLX_Types.Bit_Length is
     (32);

end Net.TCP.SACK_Block;
