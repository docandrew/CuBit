//! Motor OS Runtime Library, with a CuBit backend (src/cubit.rs, docs/rust-std.md).
//!
...
// CuBit carries the runtime table in the program instead of a VDSO.
#[cfg(all(target_os = "cubit", not(feature = "base")))]
pub mod cubit;
