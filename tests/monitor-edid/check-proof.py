"""Reject vacuous, skipped, assumed, or incomplete EDID proofs."""
import json
...
result = json.loads((Path(__file__).parent /
                     "build/gnatprove/cubit-monitor_edid.spark").read_text())
...
print(f"PASS EDID: {len(result['proof'])} proof diagnostics; no skips or assumptions")
